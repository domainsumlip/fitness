...
const days = [
  ...
  {
    day: "TUE",
    label: "Upper Body Strength + Power",
    theme: "PUSH, PULL, EXPLODE",
    color: "#00C2FF",
  ...
  {
    day: "WED",
    label: "Speed, Jumping & Coordination",
    theme: "TRAIN YOUR NERVOUS SYSTEM",
    color: "#7CFF6B",
    ...
    exercises: [
      { name: "10-Yard Sprint — Acceleration", sets: "8 reps", reps: "10 yards MAX effort", rest: "90 sec full rest between each", equipment: "Open space", mechanic: "Lean forward at 45 degrees, drive your knees aggressively, pump your arms hard. The first 10 yards is won or lost by how much force you push into the ground at a low angle. You're not running forward — you're pushing the ground backward. Every rep at full effort. Quality over quantity.", cue: "🔑 Cue: 'Drive the ground back' — not 'run forward.' Push back, not up." },
  ...
  {
    day: "THU",
    label: "Posterior Chain Power",
    theme: "HIPS AND HAMSTRINGS",
    color: "#FFD700",
  ...
  {
    day: "FRI",
    label: "Upper Body Volume + Grip",
    theme: "BUILD THE MUSCLE",
    color: "#FF6B9D",
  ...
  {
    day: "SAT",
    label: "Full Athletic Session",
    theme: "EVERYTHING COMES TOGETHER",
    color: "#BF7FFF",
    ...
    exercises: [
      { name: "Flying 20m Sprints", sets: "6 reps", reps: "Max effort", rest: "3 min full rest", equipment: "Open space", mechanic: "Take a 20m jog to build speed, then go all-out for the next 20m. This trains TOP-END speed — how fast your legs move at maximum velocity. Different from acceleration. Both are needed. At true top speed your body should feel like it's barely touching the ground.", cue: "🔑 Cue: Stay tall. Relax your face and hands. Tension in your body slows you down." },
      { name: "Jump Complex", sets: "3 rounds", reps: "5 squat jumps → 3 broad jumps → 3 max verticals", rest: "2 min between rounds", equipment: "Open space", mechanic: "Complexes train your body to sequence power through different directions. Going from squat jump to broad jump to vertical jump trains all three force vectors — vertical, horizontal, and maximal — in one flowing circuit. Each movement feeds into the next.", cue: "🔑 Cue: Rest fully between rounds. Power output is everything. Don't rush." },
  ...
  },
  {
    ...
    theme: "THIS IS WHERE YOU IMPROVE",
    color: "#555555",
    ...
    exercises: [
      ...
      { name: "Cold Shower Protocol", sets: "1", reps: "2–3 min cold at end of shower", rest: "N/A", equipment: "Shower", mechanic: "Cold water triggers norepinephrine release — a focus and recovery chemical. It reduces systemic inflammation left from the week's training and accelerates muscle recovery. 2–3 minutes at the end of a normal shower is enough to get the full effect.", cue: "🔑 Breathe slowly and controlled. Panicked breathing eliminates most of the benefit." },
      { name: "Sleep — 8–9 Hours", sets: "N/A", reps: "8–9 hours", rest: "N/A", equipment: "Dark, cool room (65–68°F)", mechanic: "Human growth hormone peaks in the first 90 minutes of deep sleep. HGH rebuilds muscle tissue and cements the motor patterns from this week's speed and coordination training. Motor skills learned in training are literally transferred to long-term memory during REM sleep. More sleep = faster improvement.", cue: "🔑 No screens 60 min before bed. Magnesium glycinate 300mg if available. Same wake time every day." }
    ],
...
export default function CalisthenicsTrainingPlan() {
  ...
  return (
    <div style={{ fontFamily: "'Courier New', monospace", background: "#080808", minHeight: "100vh", color: "#E0E0D8" }}>
      {/* Header */}
      <div style={{ padding: "28px 24px 18px", borderBottom: "1px solid #1a1a1a" }}>
        <div style={{ fontSize: "9px", letterSpacing: "5px", color: d.color, marginBottom: "6px" }}>CALISTHENICS & LIGHT WEIGHTS PROTOCOL</div>
        <h1 style={{ margin: 0, fontSize: "clamp(20px, 4vw, 38px)", fontFamily: "Georgia, serif", fontWeight: 900, letterSpacing: "-1px", lineHeight: 1.15 }}>
          STRENGTH &amp; SPEED<br /><span style={{ color: d.color }}>NO GYM REQUIRED</span>
        </h1>
        <p style={{ margin: "10px 0 0", color: "#555", fontSize: "12px", letterSpacing: "1px" }}>Bodyweight • Light Weights • Full Athletic Potential</p>
      ...
      {tab === "principles" ? (
        <div style={{ padding: "32px 24px", maxWidth: "720px" }}>
          <div style={{ fontSize: "9px", letterSpacing: "5px", color: "#FF4D00", marginBottom: "24px" }}>WHY CALISTHENICS BUILDS REAL STRENGTH AND SPEED</div>
          <div style={{ display: "grid", gap: "20px" }}>
            {principles.map((p, i) => (
              <div key={i} style={{ borderLeft: "2px solid #FF4D0033", paddingLeft: "20px", position: "relative" }}>
                <div style={{ position: "absolute", left: "-5px", top: "6px", width: "8px", height: "8px", borderRadius: "50%", background: "#FF4D00" }} />
                <div style={{ fontSize: "11px", letterSpacing: "3px", color: "#FF4D00", textTransform: "uppercase", marginBottom: "6px" }}>{p.icon} {p.title}</div>
                <div style={{ fontSize: "13px", lineHeight: "1.85", color: "#999" }}>{p.body}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "flex" }}>
          {/* Day nav */}
          <div style={{ width: "66px", minWidth: "66px", borderRight: "1px solid #161616", background: "#060606", paddingTop: "12px", display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
            {days.map((day, i) => (
          ...
          <div style={{ flex: 1, padding: "24px 28px", overflowY: "auto" }}>
            <div style={{ marginBottom: "24px" }}>
              <div style={{ fontSize: "9px", letterSpacing: "5px", color: d.color, marginBottom: "4px" }}>{d.theme}</div>
              <h2 style={{ margin: "0 0 10px", fontSize: "clamp(16px, 3vw, 26px)", fontFamily: "Georgia, serif" }}>{d.day} — {d.label}</h2>
              <div style={{ fontSize: "12px", lineHeight: "1.85", color: "#777", background: "#0d0d0d", padding: "14px 16px", borderLeft: `3px solid ${d.color}44`, maxWidth: "620px" }}>
                <span style={{ display: "block", fontSize: "8px", letterSpacing: "3px", color: d.color, marginBottom: "5px" }}>THE MECHANIC TODAY</span>
                {d.mechanic}
              </div>
            </div>
            ...
            {d.warmup.length > 0 && (
              <div style={{ marginBottom: "22px" }}>
                <div style={{ fontSize: "9px", letterSpacing: "4px", color: "#444", marginBottom: "10px" }}>WARM-UP</div>
                <div style={{ display: "flex", flexWrap: "wrap", gap: "7px" }}>
                  {d.warmup.map((w, i) => (
                    <div key={i} style={{ background: "#0e0e0e", border: "1px solid #1e1e1e", padding: "6px 12px", fontSize: "11px", color: "#666" }}>
                      <span style={{ color: d.color, marginRight: "6px" }}>{i + 1}.</span>{w}
                    </div>
                  ))}
                </div>
              </div>
            ...
            <div style={{ fontSize: "9px", letterSpacing: "4px", color: "#444", marginBottom: "10px" }}>EXERCISES — TAP TO EXPAND</div>
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              {d.exercises.map((ex, i) => (
                <div key={i} style={{
                  background: expandedEx === i ? "#0f0f0f" : "#0a0a0a",
                  border: `1px solid ${expandedEx === i ? d.color + "55" : "#1a1a1a"}`,
                  cursor: "pointer", transition: "all 0.15s"
                }} onClick={() => setExpandedEx(expandedEx === i ? null : i)}>
                  <div style={{ padding: "13px 16px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      <span style={{ color: d.color, fontSize: "10px" }}>0{i + 1}</span>
                      <span style={{ fontSize: "13px", fontWeight: "bold", letterSpacing: "0.5px" }}>{ex.name}</span>
                    </div>
                    <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
                      <span style={{ fontSize: "10px", color: "#444" }}>{ex.sets}</span>
                      <span style={{ color: expandedEx === i ? d.color : "#333", fontSize: "18px", lineHeight: 1 }}>{expandedEx === i ? "−" : "+"}</span>
                    </div>
                  </div>
                  {expandedEx === i && (
                    <div style={{ padding: "0 16px 16px", borderTop: "1px solid #1a1a1a" }}>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", margin: "12px 0" }}>
                        {[["REPS", ex.reps], ["REST", ex.rest], ["EQUIPMENT", ex.equipment]].map(([label, val]) => (
                          <div key={label} style={{ background: "#0d0d0d", border: "1px solid #222", padding: "8px 12px", minWidth: "100px" }}>
            ...
            <div style={{ marginTop: "22px", background: d.color + "0f", border: `1px solid ${d.color}33`, padding: "14px 16px" }}>
              <div style={{ fontSize: "9px", letterSpacing: "4px", color: d.color, marginBottom: "6px" }}>FINISHER</div>
              <div style={{ fontSize: "13px", color: "#ccc", lineHeight: "1.7" }}>{d.finisher}</div>
            </div>

            <div style={{ marginTop: "10px", padding: "12px 16px", background: "#0d0d0d", borderLeft: "2px solid #252525" }}>
              <span style={{ fontSize: "9px", letterSpacing: "3px", color: "#444" }}>NOTE — </span>
              <span style={{ fontSize: "12px", color: "#555" }}>{d.note}</span>
            </div>

            <div style={{ display: "flex", justifyContent: "space-between", marginTop: "28px", paddingTop: "18px", borderTop: "1px solid #161616" }}>
              {activeDay > 0
                ? <button onClick={() => { setActiveDay(activeDay - 1); setExpandedEx(null); }} style={{ background: "transparent", border: "1px solid #2a2a2a", color: "#555", padding: "9px 16px", cursor: "pointer", fontSize: "10px", letterSpacing: "2px", fontFamily: "'Courier New', monospace" }}>← {days[activeDay - 1].day}</button>
                : <div />}
              {activeDay < days.length - 1
                ? <button onClick={() => { setActiveDay(activeDay + 1); setExpandedEx(null); }} style={{ background: d.color, border: "none", color: "#000", padding: "9px 18px", cursor: "pointer", fontSize: "10px", letterSpacing: "2px", fontWeight: "bold", fontFamily: "'Courier New', monospace" }}>NEXT: {days[activeDay + 1].day} →</button>
